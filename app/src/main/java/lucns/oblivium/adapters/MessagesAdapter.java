...
public class MessagesAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int index, View convertView, ViewGroup parent) {
        ...
        if (views[index] == null) {
            ...
            LinearLayout linearLayout = (LinearLayout) views[index];
            if (index != 0) {
                linearLayout.removeView(linearLayout.findViewById(R.id.viewPaddingTop));
            }
            if (index != list.size() - 1) {
                linearLayout.removeView(linearLayout.findViewById(R.id.viewPaddingBottom));
            }
        }
        if (i) {
